...
const completionApiEndpoint = reactive({url:'http://127.0.0.1:8080/completion'})
...
const prompts = {
  ...
  "LLaMa token":"<|im_start|>system\nYou are TinyLlama, a large language model trained by Alignment Lab AI. Write out your reasoning step-by-step to be sure you get the right answers!<|im_end|>\n<|im_start|>user\nHi what is you name?!<|im_end|>\n<|im_start|>assistant"
}

const defaultInterjectWord = "\n### Human:"
